...
11. **Global Image Gallery**: A unified history viewer displaying all previously generated images across all prompt blocks, sorted by timestamp (newest first). Located immediately below the Common Prompt block.
